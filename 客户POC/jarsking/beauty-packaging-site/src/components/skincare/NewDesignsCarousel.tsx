    ...
    <section className="w-full bg-white py-12">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <h2 className="font-montserrat text-3xl md:text-[40px] font-medium leading-[1.2] text-[#1E1E1E] text-center mb-10">
          {t('allApplications.newDesigns.title', { defaultValue: 'New Designs for Skincare Packaging Set' })}
        </h2>
        ...
        <div className="relative">
          ...
          <button
            ...
            aria-label={t('common.actions.scrollLeft', { defaultValue: 'Scroll left' })}
          >
            ...
            {products.map((product, index) => (
              ...
              >
                <div className="w-[280px] h-[280px] overflow-hidden rounded-lg bg-[#f5f5f5]">
                  <img
                    src={product.src}
                    alt={t(`allApplications.newDesigns.products.${product.key}.alt`, { defaultValue: 'Skincare Packaging' })}
          ...
          <button
            ...
            aria-label={t('common.actions.scrollRight', { defaultValue: 'Scroll right' })}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
