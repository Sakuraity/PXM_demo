        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="p-8 bg-[#050505] border-l-2 border-[#d4af37]">
              <div className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3">B2B / Wholesale Priority</div>
              <p className="text-xs text-[#888] font-medium leading-relaxed uppercase tracking-wider">
                Looking for wholesale pricing or OEM/ODM services? Select &ldquo;Wholesale / B2B&rdquo; type and our team will respond within 4 hours.
              </p>
            </div>
          </motion.div>
            ...
            {submitted ? (
              <div className="h-full min-h-[400px] flex items-center justify-center p-12 bg-[#050505] border border-[#1a1a1a]">
                <div className="text-center">
                  ...
                  <p className="text-[#888] font-medium uppercase tracking-widest text-xs">We typically reply within 4 business hours.</p>
                </div>
              </div>
            ) : (
