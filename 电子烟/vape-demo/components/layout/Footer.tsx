          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4 text-xs font-bold tracking-widest uppercase">
              <div className="flex items-center gap-3 group cursor-pointer">
                ...
                <span className="group-hover:text-white transition-colors">wholesale@nexvap.com</span>
              </div>
              <div className="flex items-center gap-3 group cursor-pointer">
                <Phone className="w-4 h-4 text-[#444] group-hover:text-white transition-colors" />
                <span className="group-hover:text-white transition-colors">+86 755 2800 8899</span>
              </div>
              <div className="flex items-center gap-3 group cursor-pointer">
                <MapPin className="w-4 h-4 text-[#444] group-hover:text-white transition-colors" />
                <span className="group-hover:text-white transition-colors">Shenzhen, Guangdong, China</span>
              </div>
            </div>
          </div>
