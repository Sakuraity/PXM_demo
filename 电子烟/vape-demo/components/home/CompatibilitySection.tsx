        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="bg-[#050505] border border-[#1a1a1a]">
            ...
            <div className="flex items-center gap-4 px-8 py-6 border-b border-[#1a1a1a]">
              ...
              <div>
                <div className="text-xs font-black text-white uppercase tracking-widest">Compatibility Matrix</div>
                <div className="text-[10px] font-bold text-[#444] uppercase tracking-widest mt-0.5">NEXVAP FLUXPOD™ System</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between px-8 py-5 border-t border-[#1a1a1a]">
              <span className="text-[10px] font-bold text-[#444] uppercase tracking-widest">Full lineup available</span>
              <Link
                href="/compatibility"
          ...
          <div>
            ...
            <div className="space-y-4 mb-12">
              {[
                { label: 'FLUXPOD™ universal', desc: 'One pod system, all APEX & FLUX devices' },
                { label: 'Zero guesswork', desc: 'Instant compatibility verification' },
                { label: 'Coil auto-detection', desc: 'NEXCORE™ reads resistance on attach' },
              ].map(({ label, desc }) => (
                <div key={label} className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#666] font-medium mt-0.5">{desc}</div>
                  </div>
                </div>
              ))}
            </div>
