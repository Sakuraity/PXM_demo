...
export default function ComplianceClient({ regions }: Props) {
  ...
  const [expanded, setExpanded] = useState<string | null>('EU')
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16 border-b border-[#1a1a1a]">
          <div className="flex items-center gap-4 mb-8">
            <h2 className="text-sm font-black text-white uppercase tracking-widest">Global Certifications</h2>
        ...
        <section className="py-16 border-b border-[#1a1a1a]">
          <div className="flex items-center gap-4 mb-10">
            <h2 className="text-sm font-black text-white uppercase tracking-widest">Market-by-Market Compliance</h2>
            <div className="h-px flex-1 bg-[#1a1a1a]" />
          </div>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <div className="text-base font-black text-white uppercase tracking-tight">{region.name.en}</div>
                        <div className="flex items-center gap-2 mt-1">
                          <span className="w-1.5 h-1.5 bg-[#00ff66]" />
                          <span className="text-[10px] font-bold text-[#666] tracking-widest uppercase">Compliant</span>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        <div className="px-6 md:px-8 pb-8 border-t border-[#1a1a1a]">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                            {/* Description */}
                            <div>
                              <div className="text-[10px] font-black text-[#666] uppercase tracking-[0.2em] mb-4">Overview</div>
                              <p className="text-sm text-[#a3a3a3] font-medium leading-relaxed">{region.description.en}</p>
                            </div>

                            {/* Notes + certs */}
                            <div className="space-y-6">
                              <div>
                                <div className="text-[10px] font-black text-[#666] uppercase tracking-[0.2em] mb-4">Key Requirements</div>
                                <div className="p-4 bg-black border-l-2" style={{ borderColor: color }}>
                                  <p className="text-xs text-[#888] font-medium leading-relaxed uppercase tracking-wide">{region.notes.en}</p>
                                </div>
                              </div>

                              <div>
                                <div className="text-[10px] font-black text-[#666] uppercase tracking-[0.2em] mb-3">Certifications</div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex items-start gap-5 p-8 bg-[#050505] border-l-2 border-[#d4af37]">
              ...
              <div>
                <div className="text-xs font-black text-white uppercase tracking-widest mb-3">Regulatory Warning</div>
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-4">Need Compliance Documentation?</h3>
              <p className="text-sm text-[#888] font-medium leading-relaxed mb-8">
                Our compliance team provides full certification packages, region-specific documentation, and regulatory guidance for all markets.
              </p>
