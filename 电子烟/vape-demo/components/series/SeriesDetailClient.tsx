      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16">
          ...
          {products.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <div className="text-sm font-black text-[#666] uppercase tracking-widest">No products in this series yet</div>
            </div>
          ) : (
        ...
        >
          <h2 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tight mb-4">
            Wholesale the {series.name.en}
          </h2>
          <p className="text-[#888] font-medium mb-10 max-w-lg mx-auto text-sm">
            MOQ from 10 units · Tiered pricing · Compliance docs included
          </p>
          <Link
            href="/contact"
