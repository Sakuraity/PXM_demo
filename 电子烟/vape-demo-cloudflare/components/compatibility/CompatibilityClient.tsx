      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] font-bold tracking-widest uppercase" style={{ color: sColor }}>
                          {device.series} {t('productDetail.seriesSuffix')}
                          {fromPrice && <span className="text-[#666] ml-2">{t('compatibility.fromPrice', { price: fromPrice.toFixed(2) })}</span>}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] font-bold tracking-widest uppercase text-[#666]">
                          {nicotineLabel}
                          {fromPrice && <span className="ml-2">{t('compatibility.fromPrice', { price: fromPrice.toFixed(2) })}</span>}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {podProducts
                ...
                .map((p) => {
                  ...
                  const nicotineLabel = nicotineStrengths && nicotineStrengths.length > 0
                    ? nicotineStrengths.map((n) => `${n}mg`).join(' / ')
                    : t('compatibility.nicotineFreebase')
                  return (
                    <Link
                      key={p.slug}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-[10px] font-bold tracking-widest uppercase text-[#d4af37] mt-auto">
                        {t('products.viewDetails')} <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                      </div>
                    </Link>
                  )
                })}
        ...
        >
          <div className="flex items-start gap-6">
            ...
            <div>
              <h3 className="text-sm font-black text-white uppercase tracking-widest mb-2">{t('compatibility.engineTitle')}</h3>
