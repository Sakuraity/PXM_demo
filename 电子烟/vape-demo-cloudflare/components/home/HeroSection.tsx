...
export default function HeroSection() {
  ...
  const stats = [
    { value: '5ms', label: t('hero.stat1Label'), icon: Zap },
    { value: '8000', label: t('hero.stat2Label'), icon: Droplet },
    { value: '850mAh', label: t('hero.stat3Label'), icon: Battery },
  ]
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="inline-flex items-center gap-3 px-5 py-2 border border-[#222] bg-black/50 backdrop-blur-md mb-10 rounded-full">
              ...
              <span className="text-[10px] font-bold text-[#a3a3a3] tracking-[0.25em] uppercase">{t('hero.badge')}</span>
            </div>
            
            <h1 className="text-6xl md:text-8xl lg:text-[140px] font-black text-white leading-[0.85] tracking-tighter uppercase mb-4">
              {t('hero.title')}
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-[#ccc] to-[#666]">{t('hero.titleHighlight')}</span>
            </h1>
          </motion.div>
