      ...
      <section className="w-full bg-white py-3 border-b border-gray-100">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          <nav className="text-sm text-[#7A7A7A] font-poppins">
            <a href="/" className="hover:text-[#61CE70] transition-colors">Home</a>
            <span className="mx-2">/</span>
            <a href="/all-applications" className="hover:text-[#61CE70] transition-colors">All Applications</a>
            <span className="mx-2">/</span>
            <span className="text-[#1E1E1E]">Body Lotion Bottles</span>
          </nav>
        </div>
      </section>
    </>
